class TriggerInteractionState extends GameState {
    ...
    constructor(scene, previousState) {
        super(scene, GAME_STATES.TRIGGER_INTERACTION, previousState);
    }

    enter() {
        super.enter();
        this.scene.gameStateUI.nextTurnbutton.fsmState.exit(NEXT_TURN_BUTTON_FSM_STATES.DRAW_CARD);
    }
    ...
    onPointerDown(pointer, gameObject) {
        ...
        else if(gameObject instanceof AbilityButton && gameObject.type === "TRIGGER") gameObject.onPointerDown();
    }
