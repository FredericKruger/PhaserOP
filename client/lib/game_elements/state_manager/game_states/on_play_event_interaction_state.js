class OnPlayEventInteractionState extends GameState {
    ...
    constructor(scene, previousState) {
        super(scene, GAME_STATES.ON_PLAY_EVENT_INTERACTION, previousState);
    }
    ...
    onPointerDown(pointer, gameObject) {
        ...
        else if(gameObject instanceof AbilityButton && gameObject.type === "ON_PLAY") gameObject.onPointerDown();
    }
