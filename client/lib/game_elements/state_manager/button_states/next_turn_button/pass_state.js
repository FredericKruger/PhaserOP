...
class NextTurnButtonOnPlayEventState extends NextTurnButtonState {

    constructor(button, previousState) {
        super(button, NEXT_TURN_BUTTON_FSM_STATES.ON_PLAY_EVENT, previousState);
    }
...
class NextTurnButtonOnAttackEventState extends NextTurnButtonState {

    constructor(button, previousState) {
        super(button, NEXT_TURN_BUTTON_FSM_STATES.ON_ATTACK_EVENT, previousState);
    }
