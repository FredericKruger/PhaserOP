class LoaderScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image(ASSET_ENUMS.IMAGE_GOMMU_GOMMU_NO_MI, `${assetPath}/gommu_gommu_no_mi.png`);
        this.load.image(ASSET_ENUMS.IMAGE_IBI_IBI_NO_MI, `${assetPath}/Ibi_Ibi_no_Mi.webp`);
        ...
        this.load.image(ASSET_ENUMS.BATTLE_ONO1, `${assetPath}/dodododo.png`);
        this.load.image(ASSET_ENUMS.BATTLE_ONO2, `${assetPath}/doka.png`);
        this.load.image(ASSET_ENUMS.BATTLE_ONO3, `${assetPath}/gogogogo.png`);
        this.load.image(ASSET_ENUMS.BATTLE_ONO4, `${assetPath}/pan.png`);
        this.load.image(ASSET_ENUMS.BATTLE_ONO5, `${assetPath}/zan.png`);
        ...
        this.load.spritesheet(ASSET_ENUMS.WHITE_FLAG_SPRITESHEET, `${assetPath}/white_flag_spritesheet.png`, { frameWidth: 498, frameHeight: 280 });
    ...
    create() {
        ...
        this.anims.create({
            key: ANIMATION_ENUMS.SLEEPING_ANIMATION,
            frames: this.anims.generateFrameNumbers(ASSET_ENUMS.SLEEPING_SPRITESHEET, { start: 0, end: 2}),
            frameRate: 2,
            repeat: -1
        });
        ...
        this.anims.create({
            key: ANIMATION_ENUMS.WHITE_FLAG_ANIMATION,
            frames: this.anims.generateFrameNumbers(ASSET_ENUMS.WHITE_FLAG_SPRITESHEET, { start: 0, end: 25}),
            frameRate: 15,
            repeat: -1
        });
